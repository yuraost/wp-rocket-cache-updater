 ...
 */
add_filter('user_has_cap', __NAMESPACE__ . '\remove_cap_rocket_purge_cache', 99, 4);
function remove_cap_rocket_purge_cache($allcaps, $caps, $args, $user) {
...
add_filter('rocket_clean_domain_urls', function(){return array();});